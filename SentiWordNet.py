...
if __name__ == "__main__":
    ...
    """
    SWN_FILENAME = "/home/gabz/Documents/projetEI/SentiWordNet/SentiWordNet_3.0.0_20130122.txt"
    if os.path.exists(SWN_FILENAME):
        swn = SentiWordNetCorpusReader(SWN_FILENAME)
        for senti_synset in swn.all_senti_synsets():
            print(senti_synset.synset.name, senti_synset.pos_score, senti_synset.neg_score, senti_synset.lemmas)