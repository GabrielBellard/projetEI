...
def terms_to_graph(terms, w):
    ...
    # vertice weights the sum of the weights of all incident
    # edges(inclued out-degree and in-degree)
...
def compute_node_centrality(graph):
    ...
    # Keep in mind that degrees and w_degrees are not normalized.
    # degree
